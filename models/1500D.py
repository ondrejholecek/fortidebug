...
class Model(GenericModel):
	...
	def gen_ports(self):
		...
		self.add_port("port1",  hwnic_switch, xestats0_0, hwnic_kernel, np6drops0)
		self.add_port("port2",  hwnic_switch, xestats0_1, hwnic_kernel, np6drops0)
		...
		self.add_port("port5",  hwnic_switch, xestats0_0, hwnic_kernel, np6drops0)
		self.add_port("port6",  hwnic_switch, xestats0_1, hwnic_kernel, np6drops0)
		...
		self.add_port("port9",  hwnic_switch, xestats1_0, hwnic_kernel, np6drops1)
		self.add_port("port10", hwnic_switch, xestats1_1, hwnic_kernel, np6drops1)
		...
		self.add_port("port13", hwnic_switch, xestats1_0, hwnic_kernel, np6drops1)
		self.add_port("port14", hwnic_switch, xestats1_1, hwnic_kernel, np6drops1)
		...
		self.add_port("port17", hwnic_switch, xestats0_0, hwnic_kernel, np6drops0)
		self.add_port("port18", hwnic_switch, xestats0_1, hwnic_kernel, np6drops0)
		...
		self.add_port("port21", hwnic_switch, xestats0_0, hwnic_kernel, np6drops0)
		self.add_port("port22", hwnic_switch, xestats0_1, hwnic_kernel, np6drops0)
		...
		self.add_port("port25", hwnic_switch, xestats1_0, hwnic_kernel, np6drops1)
		self.add_port("port26", hwnic_switch, xestats1_1, hwnic_kernel, np6drops1)
		...
		self.add_port("port29", hwnic_switch, xestats1_0, hwnic_kernel, np6drops1)
		self.add_port("port30", hwnic_switch, xestats1_1, hwnic_kernel, np6drops1)
		...
		self.add_port("port35", hwnic_switch, xestats0_2, hwnic_kernel, np6drops0)
		self.add_port("port36", hwnic_switch, xestats0_3, hwnic_kernel, np6drops0)
		self.add_port("port37", hwnic_switch, xestats1_0, hwnic_kernel, np6drops1)
		self.add_port("port38", hwnic_switch, xestats1_1, hwnic_kernel, np6drops1)
		self.add_port("port39", hwnic_switch, xestats1_2, hwnic_kernel, np6drops1)
		self.add_port("port40", hwnic_switch, xestats1_3, hwnic_kernel, np6drops1)
